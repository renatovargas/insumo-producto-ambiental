...
nombres_bio <- read.xlsx("clasificacion_cruzada_bioeconomia.xlsx", 
                                            sheet = "datos", 
                                            rows= c(1:137), 
                                            cols = c(1:6), 
                                            skipEmptyRows = FALSE, 
...
# Consumo intermedio
LAB_cruda <- as.matrix(read.xlsx("MIP-AE-AE-017-CR.xlsx", 
                               sheet = "MIP 2017", 
                               rows= c(296:301), 
                               cols = c(4:256), 
                               skipEmptyRows = FALSE, 
...
nombres_l <- read.xlsx("MIP-AE-AE-017-CR.xlsx", 
                     sheet = "MIP 2017", 
                     rows= c(296:301), 
                     cols = 1, 
                     skipEmptyRows = FALSE, 
...
dim(LAB)
write.table(multip_cp,"clipboard", sep = "\t", row.names = TRUE)
